    ...
    <Dialog open={show} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 py-6">
          ...
          {/* Middle Column - Collaborator & Activity */}
          <div className="space-y-6">
          ...
          <div className="space-y-6">
            {/* About Client */}
            <div>
              <h4 className="font-medium text-gray-900 mb-3">Sobre o Cliente</h4>
            ...
            {/* About Opportunity */}
            <div>
              <h4 className="font-medium text-gray-900 mb-3">Sobre a Oportunidade</h4>
              <div className="space-y-3 text-sm">
                <div>
                ...
                <div>
                  <span className="text-gray-500">Previsão de fechamento:</span>
                ...
                <div>
                  <span className="text-gray-500">Método de contato:</span>
